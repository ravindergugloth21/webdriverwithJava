...
public class FacetWithColoutShowMore {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(3000);
        driver.findElements(By.cssSelector("button[data-expansion='open-primary']")).get(2).click();
        Thread.sleep(3000);
        driver.findElements(By.cssSelector("button[data-expansion='open-primary']")).get(4);
