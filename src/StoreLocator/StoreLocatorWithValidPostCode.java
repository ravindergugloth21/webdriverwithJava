...
public class StoreLocatorWithValidPostCode {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//body/div[@id='js-global-settings']/div[@id='wrapper']/div[@id='page']/div[@id='content']/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[1]/input[1]")).sendKeys("IG7 5NP");
		...
		//Store locator search results: IG7 5NP | Tu clothing
