...
public class StoreLocatorWithInvalidPostCode {
	...
	driver.findElement(By.xpath("//body/div[@id='js-global-settings']/div[@id='wrapper']/div[@id='page']/div[@id='content']/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[1]/input[1]")).sendKeys("ANDDC");
	...
	//Store locator search results: ANDDC | Tu clothing
